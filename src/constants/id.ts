...
export const REACTION_CONTAINER_ID = "Reactions" // aria-label

export const ISSUE_CONTAINER_ID = "issue-viewer-issue-container" // id
export const COMMENTS_CONTAINER_ID = "issue-viewer-comments-container" // id
